...
function getVerifiedData() {
  return buildScrapedEntry({
    ...
    formules: {
      ...
      'Santé Pro P1': { pourcentageBR: 100, forfaitPodologie: { montantAnnuel: 50, montantParSeance: null, nbSeancesMax: null, enveloppePartagee: 'médecines douces' } },
      'Santé Pro P2': { pourcentageBR: 150, forfaitPodologie: { montantAnnuel: 60, montantParSeance: null, nbSeancesMax: null, enveloppePartagee: 'médecines douces' } },
      'Santé Pro P3': { pourcentageBR: 200, forfaitPodologie: { montantAnnuel: 100, montantParSeance: null, nbSeancesMax: null, enveloppePartagee: 'médecines douces' } },
      'Santé Pro P4': { pourcentageBR: 300, forfaitPodologie: { montantAnnuel: 150, montantParSeance: null, nbSeancesMax: null, enveloppePartagee: 'médecines douces' } },
      'Santé Pro P5': { pourcentageBR: 500, forfaitPodologie: { montantAnnuel: 200, montantParSeance: null, nbSeancesMax: null, enveloppePartagee: 'médecines douces' } },
